...
import (
	...
	"web/backend-api/config" // mengambil konfigurasi dari file .env
	
	"github.com/gin-gonic/gin" //Framework Gin untuk HTTP routing
	"github.com/golang-jwt/jwt/v5" //Library JWT untuk membuat dan meverifikasi token
)
...
func AuthMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Jika token kosong, kembalikan respon 401 Unauthorization
		if tokenString == "" {
